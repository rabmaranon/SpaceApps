...
def initialize_pygame():
    ...
    pygame.display.set_caption("Astro Walker")
...
def load_images():
    ...
    return {'space': load_image('space.png'),
            'astro': load_image('astro.png'),
            'astro': load_image('astro.png'),
            'pipe-up': load_image('laser1.png'),
            'pipe-down': load_image('laser2.png'),
            'ground': load_image('moon.png')}
